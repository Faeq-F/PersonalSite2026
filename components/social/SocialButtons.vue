...
<template>
  <div id="HomeSocialButtonGroup" class="w-fit md:ml-30">
    <!-- Email -->
    <MazAnimatedElement direction="right" :duration="700" :delay="1400"
      ...
      <a href="mailto:faeqfaisal@hotmail.co.uk" target="_blank">
        <UPopover mode="hover" :ui="{ content: 'popoverContent' }">
          <button
            class="inline-flex items-center gap-2 md:py-2 py-1 rounded-full text-current justify-center mx-1 md:px-6 px-3">
    ...
    <MazAnimatedElement direction="right" :duration="700" :delay="1700"
      class="inline">
      <a href="http://stackoverflow.com/users/13165763/faeq" target="_blank">
        <UPopover mode="hover" :ui="{ content: 'popoverContent' }">
          <button
            class="inline-flex items-center gap-2 md:py-2 py-1 rounded-full text-current justify-center mx-1 md:px-6 px-3">
            <stackoverflow
    ...
    <!-- Calendar (no px-6 for theme styling) -->
    <MazAnimatedElement direction="right" :duration="700" :delay="1900"
      class="inline">
      <a href="https://cal.com/Faeq-F" target="_blank">
        <UPopover mode="hover" :ui="{ content: 'popoverContent' }">
          <button
            class="inline-flex items-center gap-2 md:py-2 py-1 rounded-full text-current justify-center mx-1">
...
html.petalTheme #HomeSocialButtonGroup button svg,
html.petalTheme #HomeSocialButtonGroup button span {
  filter: brightness(0) invert(0);
}

html.dark.petalTheme #HomeSocialButtonGroup button svg,
html.dark.petalTheme #HomeSocialButtonGroup button span {
